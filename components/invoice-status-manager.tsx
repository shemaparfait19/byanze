...
export function InvoiceStatusManager({ invoice, showDetails = true, compact = false }: InvoiceStatusManagerProps) {
        ...
        {showDetails && (
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              <p className="text-muted-foreground">{formatCurrency(invoice.total)}</p>
            </div>
            <div>
        ...
        {invoice.pickupDate && invoice.pickupTime && (
          <div className="pt-2 border-t">
            <div className="flex items-center gap-2 text-sm">
              ...
              <span>
                <strong>Pickup:</strong> {invoice.pickupDate} at {invoice.pickupTime}
              </span>
            </div>
          </div>
        )}
